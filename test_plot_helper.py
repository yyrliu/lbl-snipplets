...
from plot_helper import get_label_from_mapping, match_label_filter, filter_columns, add_peak_label
...
def test_get_label_from_mapping_with_string():
    ...
    assert get_label_from_mapping("10", label_mapping) == "Anneal 17 min (0.3M, no PMMA)"
    assert get_label_from_mapping("11", label_mapping) == "Anneal 13 min (0.3M, no PMMA)"
    assert get_label_from_mapping("12", label_mapping) == "Anneal 10 min (0.3M, no PMMA)"
